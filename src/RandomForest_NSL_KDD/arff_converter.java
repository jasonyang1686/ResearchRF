...
//	  for(int i=0;i<100;i++){
    ...
    loader.setSource(new File("./data/attack/spambase/attack/spambase_all_normal.data"));
 //   loader.setSource(new File("./data/OOB/inbag"+i+".txt"));
    ...
    saver.setFile(new File("./data/attack/spambase/attack/spambase_all_normal.arff"));
