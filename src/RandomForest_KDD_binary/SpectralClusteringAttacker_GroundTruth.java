...
public class SpectralClusteringAttacker_GroundTruth {
	...
	List<ArrayList<Integer>>model_list=st.clustering(count_matrix,numCluster);
		...
		for (int l=0;l<loop;l++){
			...
			loader.setSource(new File("./data/attack/NSL_KDD/attack/kddcup99_non_duplicate_10_percent_attack_B.arff"));
			Instances m_data = loader.getDataSet();
			m_data.setClassIndex(m_data.numAttributes() - 1);
			
			ArffLoader loader1 = new ArffLoader();		
			loader1.setSource(new File("./data/attack//attack/kddcup99_non_duplicate_10_percent_all_B.arff"));
