...
public class SmarterAttacker_subspace_sampling {
	...
	public List getModels(int numTree,int numSelection){
	    ...
	    for (int a=0; a<numSelection; a++){
		     models.add(arr[a]);	
		 }
		return models;
	}
	
	  public List <Double>getresult(String path,int numTree, int numSelection,Instances m_data,int guess, List<String>medians,List<Integer>real_guess_list) throws Exception {
			...
			List<String> instanceresult=new ArrayList<String>();
	 		...
	 		List<Integer>models= new ArrayList<Integer>();
		      ...
		      for (int i = 0; i < m_data.numInstances(); i++) {
                 ...
                 models = getModels(numTree,numSelection);
	...
	public static void main(String[] args) throws Exception {
	    ...
	    Collections.shuffle(Arrays.asList(arr_2));
		 ...
		 SubspaceVoteChange svc = new SubspaceVoteChange();
		 List<Integer>candidate_list=new ArrayList<Integer>();
		 
		 candidate_list=svc.getresult(path, numTree, numSelection,instancedatas,guess,medians);
         ...
         result.add(sas.getresult(path,numTree,numSelection,all_data,guess,medians,real_guess_list));
		}
