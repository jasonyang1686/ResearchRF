...
for (int i = 0; i < m_data.numInstances(); i++) {
	...
	public static void main(String[] args) throws Exception {
		...
		String path = "./data/kyoto/w_models_10/";
	    ...
	    Collections.shuffle(Arrays.asList(arr_2));
         ...
         result.add(sa.getresult(path,models,all_data,numAttributes,medians,real_guess_list));
	  //   result.add(sa.getresult(path,models,all_data,numGuess,medians,real_guess_list));
		}
