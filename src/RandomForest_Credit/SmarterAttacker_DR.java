...
public class SmarterAttacker_DR {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader br = new BufferedReader(new FileReader(new File(
				"./data/attack/credit/attack/output.txt")));
		...
		loader.setSource(new File("./data/attack/credit/attack/credit_attack.arff"));
		...
		loader.setSource(new File("./data/attack/credit/attack/credit_attack_all.arff"));
	    ...
	    for (int i=0;i<100;i++){
		 ...
		 BufferedReader br1 = new BufferedReader(new FileReader(new File(
					"./data/attack/credit/model/5,50/temp/static_weight.txt")));
