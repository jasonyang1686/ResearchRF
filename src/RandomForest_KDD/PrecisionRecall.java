...
public static void main(String[] args) throws Exception {
	for(int numAttr=1;numAttr<42;numAttr++){
	List<String>classlabels = new ArrayList<String>();
	List<String>groundtruth=new ArrayList<String>();
	List<String>differentialratio=new ArrayList<String>();
	
	 BufferedReader br = new BufferedReader(new FileReader(new File("./data/attack/kddcup99/model/kddcup99_duplicate_10_percent_model.data"))); 
