...
public class createMatrix {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader br2 = new BufferedReader(
				new FileReader(new File("./data/attack/NSL_KDD/model/NSL_KDD_model_B.csv")));
		...
		FileOutputStream fos = new FileOutputStream("./data/attack/NSL_KDD/model/5,50/temp/spectral_matrix.txt");
