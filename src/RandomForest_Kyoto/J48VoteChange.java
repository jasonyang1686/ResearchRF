...
public class J48VoteChange {
	  ...
	  public List getresult(Classifier j48,int numTest, List<Instance>instancedatas,int guess, List<String>medians,List<Integer>guess_list) throws Exception {
...
//		j48.setNumFolds(20);
	...
	/*    
	  ...
	  */   
	    ...
	    finalresult= jvc.getresult(j48, numTest,instancedatas,guess,medians,guess_list);
