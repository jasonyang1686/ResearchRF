...
public class J48Classifier {
	public List BuildJ48 (Classifier j48,int numTest, Instances attack_data,int guess,List<String>medians,List<Integer>real_guess_list) throws Exception{
	...
	for (int i=0;i<attack_data.numInstances()-1;i++){
		if (attack_data.instance(i).classValue()==j48.classifyInstance(attack_data.instance(i))){
			num_correct++;
...
//		J48 j48 = new J48();
		 ObjectInputStream ois = new ObjectInputStream(new FileInputStream("./data/Classifier0.model"));
...
//		j48.buildClassifier(data);
		...
		List<Integer>candidate_list=jvc.getresult(j48, numTest,instancedatas,guess,medians,guess_list);
...
*/
      ...
      result.add(j48c.BuildJ48(j48,numTest,attack_data,guess,medians,real_guess_list));
		}
       int total=0;
		int total_w=0;
