...
public class LeafDistribution {
						...
						if (getLevel(lines.get(i)) >= 0) {
							...
							result_1 = (no_total_r -no_right_r+yes_right_r+ 0.0) / (yes_total_r + no_total_r + 0.0);
								...
								double finalresult = Math.abs(result + result_1 - 1)
										*(yes_total-yes_right+no_right+yes_total_r +no_right_r-yes_right_r+0.0)/total_size;
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader br2 = new BufferedReader(
				new FileReader(new File("./data/attack/kddcup99_B/model/kddcup99_non_duplicate_10_percent_model_B.data")));
		...
		String path = "./data/attack/kddcup99_B/model/5,50/models/";
