...
public class SmarterAttacker_DR {
	...
	public static void main(String[] args) throws Exception {
		...
		loader.setSource(new File("./data/attack/kddcup99/attack/kddcup99_duplicate_10_percent_all.arff"));
	    ...
	    for (int i=0;i<100;i++){
		 ...
		 List<Integer>real_guess_list= new ArrayList<Integer>();
			...
			BufferedReader br2 = new BufferedReader(
					new FileReader(new File("./data/attack/kddcup99/model/kddcup99_duplicate_10_percent_model.data")));
	     ...
	     SmarterAttacker_DR sad = new SmarterAttacker_DR();
	     
         result.add(sad.getresult(path,models,all_data,guess,medians,real_guess_list));
		}
