...
public class SpectralClusteringAttacker_CompleteKnowledge {
	...
	public static void main(String[] args) throws Exception {
    	String matrix_path="./data/spambase/temp/w_spectral_matrix_20.txt";
        ...
        List<String>medians=new ArrayList<String>();
 		...
 		Map<String, Integer> label = new HashMap<String, Integer>();
      	 BufferedReader br2 = new BufferedReader(new FileReader(new File("./data/spambase/training/spambase_model_normal.data"))); 
	...
	List<ArrayList<Integer>>model_list=st.clustering(count_matrix,numCluster);
		...
		for (int l=0;l<loop;l++){
			...
			loader1.setSource(new File("./data/spambase/testing/spambase_all_normal.arff"));
		...
		String path = "./data/spambase/w_models_20/";
		 ...
		 for (int i=0;i<all_data.numInstances();i++){
		     instancedatas.add((Instance) all_data.instance(i).copy());	
		 }
	     ...
	     SpectralClusteringAttacker_CompleteKnowledge scck = new SpectralClusteringAttacker_CompleteKnowledge();
  //      result.add(scck.getresult(model_list,path,numSelection,numTree,classlabels,all_data,numAttributes,medians,real_guess_list));     
         result.add(scck.getresult(model_list,path,numSelection,numTree,classlabels,all_data,numGuess,medians,real_guess_list));
		}
