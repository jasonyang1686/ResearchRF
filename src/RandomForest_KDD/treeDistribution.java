...
//compute differential ratio matrix and total differential ratios
	...
	Map<String, Double> appear = new HashMap<String, Double>();
		...
		//		System.out.println(getLevel(lines.get(i)));
            	...
            	if (lines.get(i).contains(">")){
    				...
    				if(lines.get(i).contains(":")){
        				...
        				if (classResult.equals("No")){
        					no_num+=Integer.parseInt(getFirstValue(lines.get(i)));
        					no_num_l+=Integer.parseInt(getLastValue(lines.get(i)));       					
        				}else{
        					yes_num+=Integer.parseInt(getFirstValue(lines.get(i)));
        					yes_num_l+=Integer.parseInt(getLastValue(lines.get(i)));
        				}
    				}
            		for (int j=i+1;j<lines.size();j++){
            			...
            			//	System.out.println(close);       				
            				...
            				if (classResult.equals("No")){
            					no_num+=Integer.parseInt(getFirstValue(lines.get(j)));
            					no_num_l+=Integer.parseInt(getLastValue(lines.get(j)));
            				}else{
            					yes_num+=Integer.parseInt(getFirstValue(lines.get(j)));
            					yes_num_l+=Integer.parseInt(getLastValue(lines.get(j)));
            				}            				
            				}
            			}
            	...
            	//			System.out.println(j);
            				...
            				String classResult= getLabel(lines.get(j));
            				if (classResult.equals("No")){
            					no_num_1+=Integer.parseInt(getFirstValue(lines.get(j)));
            					no_num_1_l+=Integer.parseInt(getLastValue(lines.get(j)));
            				}else{
            					yes_num_1+=Integer.parseInt(getFirstValue(lines.get(j)));
            					yes_num_1_l+=Integer.parseInt(getLastValue(lines.get(j)));
            				}            				
            				}
            			}
            		...
            		if (getLevel(lines.get(i))>=1){
            			double result =0.0;
            			double result_1=0.0;
            			   result = (yes_num+0.0)/(yes_num+no_num+yes_num_l+no_num_l+0.0); 
             			   result_1 = (no_num_1+0.0)/(yes_num_1+no_num_1+yes_num_1_l+no_num_1_l+0.0);
             			
            			if ((yes_num+no_num+yes_num_l+no_num_l+yes_num_1+yes_num_1_l+no_num_1+no_num_1_l)>300){
   				...
   				int no_num=0;                  
            		...
            		if(lines.get(i).contains(":")){
        				...
        				if (classResult.equals("No")){
        					...
        					no_num_1+=Integer.parseInt(getFirstValue(lines.get(i)));       				       				
        					no_num+=Integer.parseInt(getLastValue(lines.get(i)));
        				}else{

        				    yes_num_1+=Integer.parseInt(getFirstValue(lines.get(i)));     				
        					yes_num+=Integer.parseInt(getLastValue(lines.get(i)));
        				}            				
            		}
            		for (int j=i+1;j<lines.size();j++){
            		  ...
            		  duplicate.add(j);	
                		...
                		if(lines.get(j).contains(":")){
            				...
            				if (classResult.equals("No")){
            				    ...
            				    no_num_1+=Integer.parseInt(getFirstValue(lines.get(j)));            				
            					no_num+=Integer.parseInt(getLastValue(lines.get(j)));
            				}else{
            				    yes_num_1+=Integer.parseInt(getFirstValue(lines.get(j)));     				
            					yes_num+=Integer.parseInt(getLastValue(lines.get(j)));
            				}            				
                		}
            		...
            		if (getLevel(lines.get(i))>=1){
            			double result =0.0;
            			double result_1=0.0;
            			   result = (yes_num_1+0.0)/(yes_num+yes_num_1+0.0);  
             			   result_1 = (no_num_1+0.0)/(no_num_1+no_num+0.0);
             			
            			if ((yes_num+no_num+yes_num_1+no_num_1)>300){
