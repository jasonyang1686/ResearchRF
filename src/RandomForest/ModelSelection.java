...
public class ModelSelection {
	public void getResult(List<String>path,List<String>classes) throws Exception {
        ...
        BufferedReader br = new BufferedReader(new FileReader(new File("./data/attack/statlog/model/5,50/temp/acu.txt"))); 	
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i=0;i<iteration;i++){
			path.add("./data/attack/statlog/model/5,50/w_models/Classifier"+i+".model");
		}

		List<String>classes = new ArrayList<String>();
        BufferedReader br = new BufferedReader(new FileReader(new File("./data/attack/statlog/model/statlog1.data"))); 
