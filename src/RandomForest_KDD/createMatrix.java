...
public class createMatrix {
					...
					if (!duplicate.contains(i)) {
						...
						if (getLevel(lines.get(i)) >=0 ) {
							...
							result_1 = (no_total - no_right + 0.0) / (no_total + 0.0);
								...
								double finalresult = Math.abs(result + result_1 - 1.0)*(yes_total-yes_right+no_right)/total_size;
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader br2 = new BufferedReader(
				new FileReader(new File("./data/attack/kddcup99/model/kddcup99_non_duplicate_10_percent_model.data")));
		...
		FileOutputStream fos = new FileOutputStream("./data/attack/kddcup99/model/5,50/temp/spectral_matrix.txt");
