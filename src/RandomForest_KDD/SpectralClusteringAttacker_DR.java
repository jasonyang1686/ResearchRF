...
public class SpectralClusteringAttacker_DR {
	...
	public static void main(String[] args) throws Exception {
    	...
    	String count_path="./data/attack/kddcup99/model/5,50/temp/count_matrix.txt";
    	String ratio_path="./data/attack/kddcup99/model/5,50/temp/ratio_matrix.txt";  
	...
	List<ArrayList<Integer>>model_list=st.clustering(ratio_matrix,numCluster);
		...
		for (int l=0;l<loop;l++){
			...
			loader1.setSource(new File("./data/attack/kddcup99/attack/kddcup99_non_duplicate_10_percent_all.arff"));
		...
		String path = "./data/attack/kddcup99/model/5,50/models/";
		 ...
		 BufferedReader br1 = new BufferedReader(new FileReader(new File(
					"./data/attack/kddcup99/model/5,50/temp/distribution.txt")));
		 String static_weight=br1.readLine();
		 while(static_weight!=null){
			String[] weights=static_weight.split("=");
				real_guess_list.add(label.get(weights[0]));
...
*/
	     ...
	     SpectralClusteringAttacker_DR scad = new SpectralClusteringAttacker_DR();
