...
public class SubspaceVoteChange {
	
	  public List getresult(String path, int numTree, int numSelection,List<Instance>instancedatas,int guess, List<String>medians) throws Exception {
			...
			Classifier[]m_Classifiers= new Classifier[models.size()];
		      ...
		      for (int i = 0; i < instancedatas.size(); i++) {
		    	...
		    	//  System.out.println(instancedatas.get(i));
		  	    ...
		  	    Integer[] arr_1 = new Integer[guess];  
