...
public class SmarterAttacker_subspace {
...
System.out.println(count_total/(num_p+num_n+0.0));
	...
	public static void main(String[] args) throws Exception {
		...
		loader.setSource(new File("./data/attack/NSL_KDD/attack/NSL_KDD_test_B.arff"));
	    ...
	    Collections.shuffle(Arrays.asList(arr_2));
	     ...
	     SmarterAttacker_subspace sas = new SmarterAttacker_subspace();
