...
public class SpectralClusteringAttacker_GroundTruth {
	...
	public static void main(String[] args) throws Exception {
    	...
    	String count_path="./data/attack/NSL_KDD/model/5,50/temp/spectral_matrix.txt";
    	String ratio_path="./data/attack/NSL_KDD/model/5,50/temp/ratio_matrix.txt";  
	...
	List<ArrayList<Integer>>model_list=st.clustering(count_matrix,numCluster);
		...
		String path = "./data/attack/NSL_KDD/model/5,50/w_models/";
		 ...
		 BufferedReader br1 = new BufferedReader(new FileReader(new File(
					"./data/attack/NSL_KDD/model/5,50/temp/ground_truth_5.txt")));
