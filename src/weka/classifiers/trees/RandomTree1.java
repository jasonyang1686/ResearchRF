 ...
 */
public class RandomTree1 extends AbstractClassifier implements OptionHandler,
  ...
  public void buildClassifier(Instances data) throws Exception {
		...
		FileOutputStream fos = new FileOutputStream("./data/Val.txt",true); 
    ...
    /*
    for (int i=0; i<attIndicesWindow.length;i++){
    	System.out.println("index :"+attIndicesWindow[i]);
    }
    */
