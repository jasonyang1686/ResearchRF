...
public class WeightModel {
	...
	public static void main(String[] args) throws Exception {
        ...
        BufferedReader br = new BufferedReader(new FileReader(new File("./data/attack/kddcup99_B/model/kddcup99_non_duplicate_10_percent_model_B.data"))); 
        String[] labels = br.readLine().split(",");
        br.close();
		
		//random number
		List<Integer>random = new ArrayList<Integer>();
        BufferedReader br1 = new BufferedReader(new FileReader(new File("./data/attack/kddcup99_B/model/5,50/random.txt"))); 
...
//        System.out.println(random.size());
        //indexCount
		FileOutputStream fos = new FileOutputStream("./data/attack/kddcup99_B/model/5,50/temp/indexCount.txt"); 
		...
		//classCount
		FileOutputStream fos1 = new FileOutputStream("./data/attack/kddcup99_B/model/5,50/temp/classCount.txt"); 
		...
		bw1.close();		
		//sliding windows
		FileOutputStream fos2 = new FileOutputStream("./data/attack/kddcup99_B/model/5,50/temp/slidingCount.txt"); 
		...
		String datapath = "./data/attack/kddcup99_B/model/5,50/OOB/inbag"+(i+1)+".arff";
		String weightpath = "./data/attack/kddcup99_B/model/5,50/weight/weight"+(i+1)+".txt";
		String savemodelpath = "./data/attack/kddcup99_B/model/5,50/w_models/Classifier"+(i+1)+".model";
