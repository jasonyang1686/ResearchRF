...
public class SpectralClusteringAttacker_sampling {
	...
	public static void main(String[] args) throws Exception {
		String vapath= "./data/attack/kddcup99_B/model/5,50/variance.txt";
        String dispath= "./data/attack/kddcup99_B/model/5,50/distribution.txt"; 
    	String count_path="./data/attack/kddcup99_B/model/5,50/temp/count_matrix.txt";
    	String ratio_path="./data/attack/kddcup99_B/model/5,50/temp/ratio_matrix.txt";  
        ...
        List<String>medians=new ArrayList<String>();
 		...
 		Map<String, Integer> label = new HashMap<String, Integer>();
      	 BufferedReader br2 = new BufferedReader(new FileReader(new File("./data/attack/kddcup99_B/model/kddcup99_non_duplicate_10_percent_model_B.data"))); 
	...
	List<ArrayList<Integer>>model_list=st.clustering(count_matrix,numCluster);
		...
		for (int l=0;l<loop;l++){
			...
			loader1.setSource(new File("./data/attack/kddcup99_B/attack/kddcup99_non_duplicate_10_percent_all_B.arff"));
		...
		String path = "./data/attack/NSL_KDD/model/5,50/models/";
         ...
         result.add(sca.getresult(model_list,path,numSelection,numTree,classlabels,all_data,guess,medians,real_guess_list));
		}
