...
public class WeightModel {
	  public void buildClassifier(String savemodelpath, Instances data, int random, int KValue) throws Exception {
		  ...
		  RandomTree_spambase_random_fly rl = new RandomTree_spambase_random_fly();
		  rl.setSeed(random);
		  rl.setKValue(KValue);
	      rl.setMaxDepth(6);  
	...
	public static void main(String[] args) throws Exception {
        ...
        BufferedReader br = new BufferedReader(new FileReader(new File("./data/attack/spambase/model/spambase_model_normal.data"))); 
        ...
        BufferedReader br1 = new BufferedReader(new FileReader(new File("./data/attack/spambase/model/5,50/temp/random.txt"))); 
...
//        System.out.println(random.size());
		...
		bw1.close();		
		//sliding windows
		FileOutputStream fos2 = new FileOutputStream("./data/attack/spambase/model/5,50/temp/slidingCount.txt"); 
		...
		String datapath = "./data/attack/spambase/model/5,50/OOB/inbag"+(i+1)+".arff";
