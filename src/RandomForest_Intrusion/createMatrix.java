...
public class createMatrix {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader br2 = new BufferedReader(
				new FileReader(new File("./data/attack/spambase/model/spambase_model_normal.data")));
		...
		FileOutputStream fos = new FileOutputStream("./data/attack/spambase/model/5,50/temp/spectral_matrix.txt");
