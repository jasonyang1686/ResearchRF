...
//    System.out.println("bag data size: "+bagData.size());
    return bagData;
  }
  ...
  public void buildClassifier(Instances data) throws Exception {
	FileOutputStream fos1 = new FileOutputStream("./data/inbag.txt"); 
	OutputStreamWriter osw1 = new OutputStreamWriter(fos1);  
	BufferedWriter bw1 = new BufferedWriter(osw1); 
	FileOutputStream fos2 = new FileOutputStream("./data/outbag.txt"); 
	OutputStreamWriter osw2 = new OutputStreamWriter(fos2);  
	BufferedWriter bw2 = new BufferedWriter(osw2); 
	FileOutputStream fos3 = new FileOutputStream("./data/textresult1.txt"); 
    ...
    if (getCalcOutOfBag()) {
      ...
      for (int m=0;m< m_Classifiers.length; m++){
    	  weka.core.SerializationHelper.write("./data/models/Classifier"+m+".model", m_Classifiers[m]);
    	  treeCount.add(0.0);
      }      
